...
function remWords() {
    ...
    (ansver11_1.toLowerCase !== game2Arr[0].toLowerCase) && (ansver11_2.toLowerCase !== game2Arr[6].toLowerCase) ? alert('DZ_2.7_Задание_11: Не повезло 2!'):
    alert('Вы были близки 3')
}
