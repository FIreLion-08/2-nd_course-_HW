// Задание_01
let a = 10;
alert(`Задание_01_1: ${a}`);

a = a + 10;
alert(`Задание_01_2: ${a}`);


// Задание_02
const age = 'Задание_02: Первый iPhone был представлен Стивом Джобсом 9 января 2007 года.';
alert(age);


// Задание_03
const userName = 'Задание_03: Создателем языка JavaScript является - Брендан Эйх.';
alert(userName);
